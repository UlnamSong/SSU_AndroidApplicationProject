...
public class Search2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(mobile.isConnected() || wifi.isConnected()){
            ...
            AlertDialog.Builder alert = new AlertDialog.Builder(Search2Activity.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
    ...
    private AdapterView.OnItemClickListener onClickListItem = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ...
            Intent intent = new Intent(Search2Activity.this, TimatableActivity.class);
            ...
            intent.putExtra("sn", s_n);
                Log.e("search2 day, updn", day + ", " + updn);
