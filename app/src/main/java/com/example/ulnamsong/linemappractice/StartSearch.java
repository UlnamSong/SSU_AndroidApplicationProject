...
public class StartSearch extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_shortestpath);
            ...
            if(mobile.isConnected() || wifi.isConnected()){
                    ...
                    AlertDialog.Builder alert = new AlertDialog.Builder(StartSearch.this, AlertDialog.THEME_DEVICE_DEFAULT_LIGHT);
    ...
    private AdapterView.OnItemClickListener onClickListItem = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
            ...
            Intent intent = new Intent(StartSearch.this, FinishSearch.class);
